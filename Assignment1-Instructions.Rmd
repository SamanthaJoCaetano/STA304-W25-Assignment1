...
- Standard margin sizes (i.e., not narrow margins)
- Standard font sizes (i.e., not extremely small) 
...
In this section you will briefly describe your report. Explain the importance of the subsequent analysis and prepare the reader for what they will read in the subsequent sections. If you do any data cleaning or data processing you should describe it (in a reproducible manner) here. It might be helpful to explain the variables of interest (i.e., the ones you will present in the subsequent sections) here and give rationale as to why investigating these variables is important to the study/inference.

### 2 Choose a Demographic Variable (1-3 paragraphs)
...
If you do any general data cleaning or data processing to demographic variable that you selected should describe it (in a reproducible manner) in this section. Make sure that your demoographic variable is clearly defined.
...
### 3 Choose an Outcome of Interest (1-3 paragraphs)
...
If you do any general data cleaning or data processing to outcome variable that you selected should describe it (in a reproducible manner) in this section. Make sure that your outcome variable is clearly defined.
...
### 4 Comparative Analysis (3-5 paragraphs)
...
### 5 Generative AI or Workflow Statement (1-2 paragraphs)
